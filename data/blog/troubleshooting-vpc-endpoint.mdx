...
- **Associate with Peered VPCs**: The private hosted zones must be associated with each peered VPC that needs to access the endpoints, not just with the central VPC where the endpoints reside.
